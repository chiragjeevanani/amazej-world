...
function fmtUSDT(x) { return x === undefined ? "—" : "USDT " + (Number(x) / 1e17).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }); }
                    ...
                    <div className="p-4 bg-secondary/50 rounded-xl border border-border">
                        ...
                        <div className="text-xl font-black text-card-foreground/90">
                            {royalty?.lastClaimDate ? (
                                <ClaimCountdown nextClaimAtSec={(royalty?.lastClaimDate + 86400n)} />
